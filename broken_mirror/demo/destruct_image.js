export class DestructImage{
  ...
  constructor(options){
    ...
    // 処理中は何もしない
    if(typeof this.img.destructImageFlag !== 'undefined' && img.destructImageFlag){return -1}
    ...
    // 枠をbodyに追加
    document.body.appendChild(this.frameElm)
    ...
    this.groups.forEach((group, i) => {
      group.forEach((polygon, j) => {
        ...
        imgElm.src = imgSrc
        imgElm.className = options.element.className
